(function () {
  ...
  function hydrateStudyPage() {
    ...
    function getBestTruthStatement() {
      const freshSession = getStudySession();
      const freshState = getStoredTrail();

      return (
        (freshSession.trailMap && freshSession.trailMap.truthStatement) ||
        freshSession.truthStatement ||
        freshState.truthStatement ||
        support.truth
      );
    }
    ...
    truthParagraph.textContent = getBestTruthStatement();
    ...
    setStudySession({
      ...
      scriptureConnection: 'Scripture reference required (not generated)',
      truthStatement: getBestTruthStatement(),
...
(function () {
  ...
  function updateStatusBlocks(args) {
    const user = args.user;
    const cloudStudies = args.cloudStudies;
    const cloudJournal = args.cloudJournal;
    const localStudies = args.localStudies;
    const localJournal = args.localJournal;
